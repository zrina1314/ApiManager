...
public class SearchDto implements Serializable {
	...
	private String requestMethod = ""; // EGMAS请求Method , 参与分词搜索
	...
	public SearchDto(String id, String title, String type, String url, String content, String version, String moduleName, String createTime, String requestMethod) {
		this(id, title, type, url, content, version, moduleName, createTime);
