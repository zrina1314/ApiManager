...
public class InterfaceEgmasPDFDto implements Serializable{
	/**
	 * 生成pdf
	 */
	private static final long serialVersionUID = 1L;
	private InterfaceEgmas model;
	...
	public InterfaceEgmas getModel() {
		return model;
	}
	public void setModel(InterfaceEgmas model) {
		this.model = model;
	}
