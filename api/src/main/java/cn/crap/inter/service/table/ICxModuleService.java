...
public interface ICxModuleService extends IBaseService<CxModule> {
	/**
	 * 
	 * @param picks
	 * @param idPre
	 ...
	 *            数据类型
	 * @param value
	 *            选中后的值：为空则为datacenter.name ，不为空则使用datacenter.id,datacenter.name
	 *            替换value中的moduleId，moduleName
	 * @param suffix
	 */
